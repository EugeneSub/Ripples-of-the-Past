...
public class KosmXSnakeMufflerHandler extends AnimLayerHandler<ModifierLayer<IAnimation>> implements BasicToggleAnim {
	private static final float SPEED = 1.2F;

    public KosmXSnakeMufflerHandler(ResourceLocation id) {
        super(id);
    }
