...
public class KosmXCaesarFinalHamonHandler extends AnimLayerHandler<ModifierLayer<IAnimation>> implements BasicToggleAnim {


    public KosmXCaesarFinalHamonHandler(ResourceLocation id) {
        super(id);
    }
    ...
    private static final ResourceLocation ANIM = new ResourceLocation(JojoMod.MOD_ID, "caesar_final_hamon");
    @Override
