...
public class KosmXHamonConfusionHandler extends AnimLayerHandler<ModifierLayer<IAnimation>> implements BasicToggleAnim {
	private static final float SPEED = 1.2F;

    public KosmXHamonConfusionHandler(ResourceLocation id) {
        super(id);
    }
    ...
    private static final ResourceLocation PATH = new ResourceLocation(JojoMod.MOD_ID, "hamon_confusion");
}
