...
public class KosmXHamonConfusion extends AnimLayerHandler<ModifierLayer<IAnimation>> implements BasicToggleAnim {
	private static final float SPEED = 1.2F;

    public KosmXHamonConfusion(ResourceLocation id) {
        super(id);
    }
